<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:77:"D:\WWW\phpStudy\WWW\demo\tp5\public/../application/admin\view\login\login.htm";i:1493801652;}*/ ?>
<!doctype html>
<html lang="en">
    <head>
        <meta charset="UTF-8">
                ...
                <div class="login-main pr">
                    <form action="<?php echo url('login'); ?>" method="post" class="login-form">
                        ...
                        <div id="itemBox" class="item-box">
                            ...
                            <div>
                                <img class="verifyimg reloadverify" alt="点击切换" src="<?php echo captcha_src(); ?>" alt="captcha">
                            </div>
                        </div>
        ...
        <script type="text/javascript">
            ...
            $("form").submit(function(){
                ...
                if ($.trim(password).length == 0) {
                    self.find(".check-tips").text('密码不能为空！');
                    return false;
                }
                
                //$('#password').val(encrypt_pass(password));
